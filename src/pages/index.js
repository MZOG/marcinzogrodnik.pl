    ...
    <Layout homepage={true}>
      ...
      <section className="homepage">
          ...
          <div className="container">
            <div className="homepage__hero-text">
              ...
              <svg
                ...
                width="20.033"
                height="19.665"
                viewBox="0 0 20.033 19.665"
              >
                <g
                  id="Component_1_55"
                  data-name="Component 1 – 55"
                  transform="matrix(0.966, -0.259, 0.259, 0.966, 0, 4.262)"
                  opacity="0.5"
                >
                  <g
                    id="Path_23"
        ...
        <div className="homepage__offer" id="oferta">
          <div className="container">
            <h2>Oferta</h2>
            <div className="homepage__offer-content">
              <div className="homepage__offer-item">
                ...
                <Link
                  to="/oferta/strony-internetowe-wordpress"
              ...
              <div className="homepage__offer-item">
                ...
                <Link
                  to="/oferta/strony-internetowe-jamstack"
                  className="btn secondary"
                >
                  Więcej
                </Link>
            ...
            <div className="homepage__offer-steps">
              ...
              <div className="homepage__offer-steps-item">
                <div className="homepage__offer-steps-item-header">
                  <svg
                    ...
                    width="60.217"
                    height="60.217"
                    viewBox="0 0 60.217 60.217"
                  >
                    <g
                      id="Layer_4"
                      data-name="Layer 4"
                      transform="translate(17.463 17.463)"
                    >
                      <ellipse
                        id="Ellipse_7"
                        data-name="Ellipse 7"
                        ...
                        rx="15.5"
                        ry="15"
                        transform="translate(-0.463 -0.246)"
                        fill="#fb3c54"
                      />
                    </g>
                    <g id="Layer_2" data-name="Layer 2">
                      <path
                        id="Path_29"
                        data-name="Path 29"
                        d="M50.181,2.509a7.536,7.536,0,0,1,7.527,7.527V50.181a7.536,7.536,0,0,1-7.527,7.527H10.036a7.536,7.536,0,0,1-7.527-7.527V10.036a7.536,7.536,0,0,1,7.527-7.527Zm0-2.509H10.036A10.036,10.036,0,0,0,0,10.036V50.181A10.036,10.036,0,0,0,10.036,60.217H50.181A10.036,10.036,0,0,0,60.217,50.181V10.036A10.036,10.036,0,0,0,50.181,0Z"
                        fill="#fff"
                      />
                    </g>
                    <g
                    ...
                    >
                      ...
                      <path
                        id="Path_31"
                        data-name="Path 31"
                        d="M14.764,14.009H12.255a1.255,1.255,0,1,1,0-2.509h2.509a1.255,1.255,0,1,1,0,2.509Z"
                        transform="translate(2.8 3.554)"
                        fill="#fff"
                      />
                      <path
                        id="Path_32"
                        data-name="Path 32"
                        d="M17.264,14.009H14.755a1.255,1.255,0,1,1,0-2.509h2.509a1.255,1.255,0,1,1,0,2.509Z"
                        transform="translate(6.572 3.554)"
                        fill="#fff"
                      />
                      <path
                        id="Path_33"
                        data-name="Path 33"
                        d="M12.264,14.009H9.755a1.255,1.255,0,1,1,0-2.509h2.509a1.255,1.255,0,1,1,0,2.509Z"
                        transform="translate(-0.973 3.554)"
                        fill="#fff"
                      />
                    </g>
                  </svg>
                ...
                <p>
                  Opowiedz o swoim pomyśle, jakie masz wymagania, oraz co jest
                  dla Ciebie najważniejsze. Razem dobierzemy odpowiednie
                  technologie, aby Twoja strona była idealna i w rozsądnej
                  cenie.
                </p>
              </div>
              ...
              <div className="homepage__offer-steps-item">
                  ...
                  >
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                      <path
                        id="Path_37"
                        data-name="Path 37"
                        d="M50.115,2.506a7.526,7.526,0,0,1,7.517,7.517V50.115a7.526,7.526,0,0,1-7.517,7.517H10.023a7.526,7.526,0,0,1-7.517-7.517V10.023a7.526,7.526,0,0,1,7.517-7.517Zm0-2.506H10.023A10.023,10.023,0,0,0,0,10.023V50.115A10.023,10.023,0,0,0,10.023,60.138H50.115A10.023,10.023,0,0,0,60.138,50.115V10.023A10.023,10.023,0,0,0,50.115,0Z"
                        fill="#fff"
                      />
                    </g>
                    <g
                      id="Layer_3"
                      data-name="Layer 3"
                      transform="translate(14.433 14.433)"
                    >
                      <path
                        id="Path_38"
                        data-name="Path 38"
                        d="M17.528,27.15H7.906A2.409,2.409,0,0,1,5.5,24.744V7.906A2.409,2.409,0,0,1,7.906,5.5h9.622a2.409,2.409,0,0,1,2.406,2.406V24.744a2.409,2.409,0,0,1-2.406,2.406Zm0-2.406v1.2l0-1.2ZM7.906,7.906V24.744h9.622V7.906Z"
                        transform="translate(-5.5 -5.5)"
                        fill="#fff"
                      />
                      <path
                        id="Path_39"
                        data-name="Path 39"
                        d="M17.528,22.717H7.906A2.409,2.409,0,0,1,5.5,20.311V17.906A2.409,2.409,0,0,1,7.906,15.5h9.622a2.409,2.409,0,0,1,2.406,2.406v2.406A2.409,2.409,0,0,1,17.528,22.717Zm0-2.406v1.2l0-1.2ZM7.906,17.906v2.406h9.622V17.906Z"
                        transform="translate(-5.5 8.555)"
                        fill="#fff"
                      />
                      <path
                        id="Path_40"
                        data-name="Path 40"
                        d="M24.528,26.933H14.906A2.409,2.409,0,0,1,12.5,24.528V14.906A2.409,2.409,0,0,1,14.906,12.5h9.622a2.409,2.409,0,0,1,2.406,2.406v9.622A2.409,2.409,0,0,1,24.528,26.933Zm0-2.406v1.2l0-1.2Zm-9.622-9.622v9.622h9.622V14.906Z"
                      ...
                      <path
                        id="Path_41"
                        data-name="Path 41"
                        d="M24.528,19.933H14.906A2.409,2.409,0,0,1,12.5,17.528V7.906A2.409,2.409,0,0,1,14.906,5.5h9.622a2.409,2.409,0,0,1,2.406,2.406v9.622a2.409,2.409,0,0,1-2.406,2.406Zm0-2.406v1.2l0-1.2ZM14.906,7.906v9.622h9.622V7.906Z"
                        transform="translate(4.339 -5.5)"
                        fill="#fff"
                      />
                    </g>
                  </svg>
                ...
                <p>
                  ...
                  akceptacji zabieram się do pracy nad stroną. Dostaniesz link
                  do wersji dev, w celu sprawdzania postępów oraz ewentualnych
                  zmian.
                </p>
              </div>
              ...
              <div className="homepage__offer-steps-item">
                <div className="homepage__offer-steps-item-header">
                  <svg
                    ...
                    width="62.722"
                    height="62.722"
                    viewBox="0 0 62.722 62.722"
                  >
                    <g
                      id="Layer_4"
                      data-name="Layer 4"
                      transform="translate(17.9 17.9)"
                    >
                      <circle
                        id="Ellipse_8"
                        data-name="Ellipse 8"
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                      <path
                        id="Path_34"
                        data-name="Path 34"
                        d="M52.268,2.613a7.849,7.849,0,0,1,7.84,7.84V52.268a7.849,7.849,0,0,1-7.84,7.84H10.454a7.849,7.849,0,0,1-7.84-7.84V10.454a7.849,7.849,0,0,1,7.84-7.84Zm0-2.613H10.454A10.454,10.454,0,0,0,0,10.454V52.268A10.454,10.454,0,0,0,10.454,62.722H52.268A10.454,10.454,0,0,0,62.722,52.268V10.454A10.454,10.454,0,0,0,52.268,0Z"
                        fill="#fff"
                      />
                    </g>
                    <g
                      id="Layer_3"
                      data-name="Layer 3"
                      transform="translate(14.239 14.239)"
                    >
                      <path
                        id="Path_35"
                        data-name="Path 35"
                        d="M18.67,31.841a13.17,13.17,0,1,1,13.17-13.17A13.17,13.17,0,0,1,18.67,31.841Zm0-23.707A10.536,10.536,0,1,0,29.207,18.67,10.536,10.536,0,0,0,18.67,8.134Z"
                        transform="translate(-5.5 -5.5)"
                        fill="#fff"
                      />
                      <path
                        id="Path_36"
                        data-name="Path 36"
                        d="M23.719,25.036a1.312,1.312,0,0,1-.931-.386l-7.9-7.9a1.317,1.317,0,1,1,1.862-1.862l7.9,7.9a1.317,1.317,0,0,1-.931,2.248Z"
                        transform="translate(9.207 9.207)"
                        fill="#fff"
                      />
                    </g>
                  </svg>
                ...
                <p>
                  Każda strona od samego początku jest tworzona pod SEO, oraz
                  wydajność. Przed oddaniem zakończeniem projektu sprawdzam
                  jakość strony, oraz przedstawiam końcowy raport.
                </p>
              </div>
              ...
              <div className="homepage__offer-steps-item">
                <div className="homepage__offer-steps-item-header">
                  <svg
                    ...
                    width="62.311"
                    height="62.311"
                    viewBox="0 0 62.311 62.311"
                  >
                    <g
                      id="Layer_4"
                      data-name="Layer 4"
                      transform="translate(17.279 17.223)"
                    >
                      <circle
                        id="Ellipse_6"
                        data-name="Ellipse 6"
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                      <path
                        id="Path_25"
                        data-name="Path 25"
                        d="M51.926,2.6a7.8,7.8,0,0,1,7.789,7.789V51.926a7.8,7.8,0,0,1-7.789,7.789H10.385A7.8,7.8,0,0,1,2.6,51.926V10.385A7.8,7.8,0,0,1,10.385,2.6Zm0-2.6H10.385A10.385,10.385,0,0,0,0,10.385V51.926A10.385,10.385,0,0,0,10.385,62.311H51.926A10.385,10.385,0,0,0,62.311,51.926V10.385A10.385,10.385,0,0,0,51.926,0Z"
                        fill="#fff"
                      />
                    </g>
                    <g
                      id="Layer_3"
                      data-name="Layer 3"
                      transform="translate(14.847 14.843)"
                    >
                      <path
                        id="Path_26"
                        data-name="Path 26"
                        d="M12.717,28.754A6.755,6.755,0,0,1,7.94,17.221l3.505-3.5A6.756,6.756,0,1,1,21,23.274l-3.5,3.5a6.74,6.74,0,0,1-4.78,1.977ZM9.85,24.866a4.063,4.063,0,0,0,5.735,0l3.5-3.5a4.054,4.054,0,1,0-5.733-5.733l-3.5,3.5A4.064,4.064,0,0,0,9.85,24.866Z"
                        transform="translate(-5.966 3.869)"
                        fill="#fff"
                      />
                      <path
                        id="Path_27"
                        data-name="Path 27"
                        d="M18.5,22.978a6.753,6.753,0,0,1-4.777-11.53l3.5-3.5A6.757,6.757,0,0,1,26.778,17.5L23.273,21A6.737,6.737,0,0,1,18.5,22.978ZM22,8.668a4.047,4.047,0,0,0-2.869,1.186l-3.5,3.5a4.054,4.054,0,1,0,5.733,5.733l3.505-3.5A4.054,4.054,0,0,0,22,8.668Z"
                        transform="translate(3.864 -5.964)"
                        fill="#fff"
                      />
                      <path
                        id="Path_28"
                        data-name="Path 28"
                        d="M10.789,23.289a1.351,1.351,0,0,1-.955-2.307L20.982,9.833a1.351,1.351,0,1,1,1.911,1.911L11.744,22.893a1.346,1.346,0,0,1-.955.4Z"
                        transform="translate(-0.055 -0.051)"
                        fill="#fff"
                      />
                    </g>
                  </svg>
                ...
                <p>
                  Jestem do Twojej dyspozycji w razie ewentualnych zmian na
                  stronie internetowej. Pomogę w każdej sytuacji, aby Twoja
                  strona była zawsze dostępna dla klientów.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="homepage__testimonials-before">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path
                fill="#fb3c54"
                fillOpacity="1"
                d="M0,160L80,165.3C160,171,320,181,480,202.7C640,224,800,256,960,245.3C1120,235,1280,181,1360,154.7L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"
              ></path>
            </svg>
          </div>
          <div className="container">
            ...
            <div className="homepage__testimonials-item">
              <p>
                Współpraca z Marcinem była wspaniała. W błyskawicznym tempie
                odpowiadał na wszystkie moje zapytania i zamieszczał kolejne
                elementy na stronie. W cierpliwy sposób tłumaczył na czym polega
                budowanie strony internetowej i na czym jako przedsiębiorca
                powinnam się skupić najbardziej. W stu procentach spełnił moje
                oczekiwania, zatem mogę go polecić jako świetnego fachowca!
              </p>
          ...
          <div className="homepage__testimonials-after">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
              <path
                fill="#fb3c54"
                fillOpacity="1"
                d="M0,32L80,32C160,32,320,32,480,37.3C640,43,800,53,960,74.7C1120,96,1280,128,1360,144L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"
              ></path>
            </svg>
          </div>
        </div>
