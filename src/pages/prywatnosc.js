    ...
    <Layout>
        <SEO title="Polityka Prywatności" description="Polityka prywatności storny marcinzogrodnik.pl" />
            <section className="not-found">
                ...
                <ul className="terms">
                    <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: https://marcinzogrodnik.pl</li>
                    <li>Operatorem serwisu oraz Administratorem danych osobowych jest: Marcin Zogrodnik - Ułańska 66, 43-143</li>
                    <li>Adres kontaktowy poczty elektronicznej operatora: kontakt@marcinzogrodnik.pl</li>
