        ...
        <div className="container">
          ...
          <ol>
            <li>
              ...
              adresem: <strong>marcinzogrodnik.pl</strong>
            </li>
            <li>
            ...
            <li>
              ...
              <strong>kontakt@marcinzogrodnik.pl</strong>
            </li>
            <li>
          ...
          <ol>
            <li>
              ...
              serwisu, a jako że wymagają one zgody obu stron, dotyczą one zgód
              na przetwarzanie danych osobowych udzielonych po dacie dokonania
              zmiany Polityki Prywatności. W odniesieniu do zgód na
              przetwarzanie danych osobowych udzielonych przed zmianą Polityki
              Prywatności, zastosowanie ma Polityka Prywatności w brzmieniu
              obowiązującym w chwili udzielenia zgody
            </li>
            <li>
              Zmiany wprowadzane do Polityki Prywatności nie wpływają i nigdy
              nie wpłyną na podstawową zasadę: Marcin Zogrodnik - Strony
              Internetowy nie sprzedaje podmiotom trzecim danych personalnych
              czy adresowych klientów oraz użytkowników należącego do serwisu
              Marcin Zogrodnik - Strony Internetowe i jego ewentualnych
              newsletter’ów.
            </li>
          </ol>
        </div>
